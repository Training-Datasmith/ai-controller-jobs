...
echo $enc->html($this->translate('controller/jobs', 'Your watched products'), $enc::TRUST);
...
echo $enc->html(nl2br($this->translate('controller/jobs', 'One or more products you are watching have been updated.')), $enc::TRUST);
