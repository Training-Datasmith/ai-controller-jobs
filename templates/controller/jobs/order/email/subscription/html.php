...
echo $enc->html($this->translate('controller/jobs', 'Your subscription'), $enc::TRUST);
...
echo $enc->html($this->get('emailIntro'));
...
echo nl2br($enc->html($this->translate('controller/jobs', 'The subscription for the product has ended'), $enc::TRUST));
?>:</div></td></tr><tr><td align="left" class="email-common-intro" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"> <?php 
switch ($this->subscription_item->get_reason()) {
    case -1:
        ?> <?php 
        echo nl2br($enc->html($this->translate('controller/jobs', 'The payment couldn\'t be renewed'), $enc::TRUST));
        ?> <?php 
        break;
    case 1:
        ?> <?php 
        echo nl2br($enc->html($this->translate('controller/jobs', 'You\'ve cancelled the subscription'), $enc::TRUST));
        ?> <?php 
}
?> </div></td></tr></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="common-summary-detail-outlook common-summary-outlook" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]--><div class="common-summary-detail common-summary" style="Margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;"><!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]--><div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tr><td align="left" class="basket" style="font-size:0px;padding:10px 25px;word-break:break-word;"><table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;"><thead><th css-class="header" colspan="3"><?php 
echo $enc->html($this->translate('controller/jobs', 'Details'), $enc::TRUST);
?></th></thead><tbody class="details"><tr class="product"><td class="image"> <?php 
if (($url = $this->order_product_item->get_media_url()) !== '') {
    ?> <img class="product-image" src="<?php 
    echo $enc->attr($this->content($url));
    ?>" height="150"> <?php 
}
?> </td><td class="name"> <?php 
$params = array_merge($this->param(), ['currency' => $this->order_product_item->get_price()->get_currency_id(), 'd_name' => $this->order_product_item->get_name('url'), 'd_prodid' => $this->order_product_item->get_parent_product_id() ?: $this->order_product_item->get_product_id(), 'd_pos' => '']);
?> <a class="product-name" href="<?php 
echo $enc->attr($this->url($this->order_product_item->get_target() ?: $target, $cntl, $action, $params, [], $config));
?>"> <?php 
echo $enc->html($this->order_product_item->get_name(), $enc::TRUST);
?> </a></td><td class="price"> <?php 
echo sprintf($price_format, $this->number($this->order_product_item->get_price()->get_value(), $this->order_product_item->get_price()->get_precision()), $this->translate('currency', $this->order_product_item->get_price()->get_currency_id()));
?> </td></tr></tbody></table></td></tr></table></div><!--[if mso | IE]></td></tr></table><![endif]--></td></tr></tbody></table></div><!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="email-common-outro-outlook" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]--><div class="email-common-outro" style="Margin:0px auto;max-width:600px;"><table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;"><tbody><tr><td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;"><!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]--><div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%"><tr><td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"><div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"> <?php 
echo $enc->html(nl2br($this->translate('controller/jobs', 'If you have any questions, please reply to this e-mail')), $enc::TRUST);
