...
<?php break;
case 4: /// Payment e-mail intro with order ID (%1$s), order date (%2$s) and payment status (%3$s)?>
...
<?php break;
case 5: /// Payment e-mail intro with order ID (%1$s), order date (%2$s) and payment status (%3$s)?>
...
<?php break;
case 6: /// Payment e-mail intro with order ID (%1$s), order date (%2$s) and payment status (%3$s)?>
...
<?php break;
default: /// Payment e-mail intro with order ID (%1$s), order date (%2$s) and payment status (%3$s)?>
