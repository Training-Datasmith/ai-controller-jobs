...
class Base extends \Aimeos\Controller\Jobs\Base
{
    ...
    protected function get_default_mapping(): array
    {
        return ['item' => [
            ...
            // e.g. unique EAN code
            1 => 'customer.label',
            // UTF-8 encoded text, also used as customer name
            2 => 'customer.salutation',
            3 => 'customer.company',
            4 => 'customer.vatid',
            5 => 'customer.title',
            ...
            23 => 'customer.birthday',
            24 => 'customer.status',
        ], 'group' => [25 => 'customer.groups'], 'address' => [26 => 'customer.address.salutation', 27 => 'customer.address.company', 28 => 'customer.address.vatid', 29 => 'customer.address.title', 30 => 'customer.address.firstname', 31 => 'customer.address.lastname', 32 => 'customer.address.address1', 33 => 'customer.address.address2', 34 => 'customer.address.address3', 35 => 'customer.address.postal', 36 => 'customer.address.city', 37 => 'customer.address.state', 38 => 'customer.address.languageid', 39 => 'customer.address.countryid', 40 => 'customer.address.telephone', 41 => 'customer.address.telefax', 42 => 'customer.address.mobile', 43 => 'customer.address.email', 44 => 'customer.address.website', 45 => 'customer.address.longitude', 46 => 'customer.address.latitude', 47 => 'customer.address.birthday'], 'property' => [48 => 'customer.property.type', 49 => 'customer.property.languageid', 50 => 'customer.property.value']];
    }
    /**
     ...
     */
    protected function get_processors(array $mappings): \Aimeos\Controller\Jobs\Common\Customer\Import\Csv\Processor\Iface
    {
        unset($mappings['item']);
