...
class Base extends \Aimeos\Controller\Jobs\Base
{
     ...
     */
    protected function get_cache(string $type, ?string $name = null): \Aimeos\Controller\Jobs\Common\Product\Import\Csv\Cache\Iface
    {
    ...
    {
        return ['item' => [0 => 'product.code', 1 => 'product.label', 2 => 'product.type', 3 => 'product.status'], 'text' => [4 => 'text.type', 5 => 'text.content', 6 => 'text.type', 7 => 'text.content'], 'media' => [8 => 'media.url'], 'price' => [9 => 'price.currencyid', 10 => 'price.quantity', 11 => 'price.value', 12 => 'price.taxrate'], 'attribute' => [13 => 'product.lists.type', 14 => 'attribute.code', 15 => 'attribute.type'], 'product' => [16 => 'product.code', 17 => 'product.lists.type'], 'property' => [18 => 'product.property.value', 19 => 'product.property.type'], 'catalog' => [20 => 'catalog.code', 21 => 'catalog.lists.type']];
    }
    /**
     ...
     * @throws \LogicException If class can't be instantiated
     */
    protected function get_processors(array $mappings): \Aimeos\Controller\Jobs\Common\Product\Import\Csv\Processor\Iface
    {
        unset($mappings['item']);
        $context = $this->context();
        $config = $context->config();
