...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testProcessMultiple()
    {
        ...
        $expected = [
            0 => [ 'name', 'Job CSV test' ],
            1 => [ 'short', 'Short: Job CSV test' ],
            2 => [ 'long', 'Long: Job CSV test' ],
            3 => [ 'long', 'Long: Job CSV test 2' ],
        ];
    ...
    public function testProcessListtypes()
    {
        ...
        $this->context->config()->set('controller/jobs/supplier/import/csv/processor/text/listtypes', [ 'default' ]);
