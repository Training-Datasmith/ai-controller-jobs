...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $prodcodes = [ 'job_csv_test', 'job_csv_test2' ];
        $nondelete = [ 'attribute', 'product', 'catalog' ];
        $delete = [ 'media', 'price', 'text' ];
    ...
    {
        $prodcodes = [ 'job_csv_test', 'job_csv_test2' ];
        $nondelete = [ 'attribute', 'product' ];
        $delete = [ 'media', 'price', 'text' ];

        $config = $this->context->config();
        $mapping = $config->get('controller/jobs/product/import/csv/mapping', []);
        $mapping['item'] = [ 0 => 'product.label', 1 => 'product.code' ];
